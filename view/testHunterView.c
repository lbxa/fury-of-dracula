...
int main(void) {
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    Message messages[] = {"Hello", "Goodbye", "Stuff", "...", "Mwahahahaha"};
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    Message messages[] = {"Hello", "Goodbye",     "Stuff",
                          "...",   "Mwahahahaha", "Aha!"};
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    Message messages[] = {"Party at Geneva",
                          "Okay",
                          "Sure",
                          "Let's go",
                          "Mwahahahaha",
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    assert(HvGetScore(hv) == GAME_START_SCORE - 4 * SCORE_LOSS_DRACULA_TURN -
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    assert(HvGetScore(hv) == GAME_START_SCORE - 7 * SCORE_LOSS_DRACULA_TURN -
  ...
  {  ///////////////////////////////////////////////////////////////////
...

    {
      ...
      int pathLength = -1;
      PlaceId *path = HvGetShortestPathTo(hv, PLAYER_LORD_GODALMING, BARCELONA,
                                          &pathLength);
      assert(pathLength == 2);
...

    {
      ...
      int pathLength = -1;
      PlaceId *path =
          HvGetShortestPathTo(hv, PLAYER_LORD_GODALMING, COLOGNE, &pathLength);
      assert(pathLength == 3);
      assert(path[0] == MADRID);
...

    {
      ...
      int pathLength = -1;
      PlaceId *path =
          HvGetShortestPathTo(hv, PLAYER_VAN_HELSING, HAMBURG, &pathLength);
      assert(pathLength == 3);
...

    {
      ...
      int pathLength = -1;
      PlaceId *path =
          HvGetShortestPathTo(hv, PLAYER_MINA_HARKER, CONSTANTA, &pathLength);
      assert(pathLength == 4);
...

    {
      ...
      int pathLength = -1;
      PlaceId *path = HvGetShortestPathTo(hv, PLAYER_DR_SEWARD, CASTLE_DRACULA,
                                          &pathLength);
      assert(pathLength == 7);
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    int numLocs = -1;
    PlaceId *locs = HvWhereCanTheyGoByType(hv, PLAYER_LORD_GODALMING, true,
                                           false, false, &numLocs);
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    printf(
        "Checking Paris rail connections "
        "(Lord Godalming, Round 1)\n");
    ...
    int numLocs = -1;
    PlaceId *locs = HvWhereCanTheyGoByType(hv, PLAYER_LORD_GODALMING, false,
                                           true, false, &numLocs);
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    printf(
        "Checking Adriatic Sea boat connections "
        "(Lord Godalming, Round 1)\n");
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    printf(
        "Checking Szeged road connections "
        "(Dracula, Round 1)\n");

    char *trail = "GSZ.... SGE.... HGE.... MGE.... DSZ.V..";

    Message messages[5] = {};
    HunterView hv = HvNew(trail, messages);

    int numLocs = -1;
    PlaceId *locs = HvWhereCanTheyGoByType(hv, PLAYER_DRACULA, true, false,
                                           false, &numLocs);
    assert(numLocs == 5);
    sortPlaces(locs, numLocs);
