...
int main(void) {
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    Message messages[14] = {"Hello", "Rubbish", "Stuff", "", "Mwahahah",
                            "Aha!",  "",        "",      "", "Back I go"};
  ...
  {  ///////////////////////////////////////////////////////////////////
    ...
    // Lord Godalming's move/location history
    {
      ...
      bool canFree = false;
      PlaceId *moves =
          GvGetMoveHistory(gv, PLAYER_LORD_GODALMING, &numMoves, &canFree);
      assert(numMoves == 7);
    ...
    // Dracula's move/location history
    {
      ...
      bool canFree = false;
      PlaceId *moves =
          GvGetMoveHistory(gv, PLAYER_DRACULA, &numMoves, &canFree);
      assert(numMoves == 6);
...

    {
      ...
      bool canFree = false;
      PlaceId *locs =
          GvGetLocationHistory(gv, PLAYER_DRACULA, &numLocs, &canFree);
      assert(numLocs == 6);
  ...
  {  ///////////////////////////////////////////////////////////////////
...

    {
      ...
      int numLocs = -1;
      PlaceId *locs = GvGetReachableByType(gv, PLAYER_LORD_GODALMING, 1, GALATZ,
    ...
    {
      printf(
          "\tChecking Ionian Sea boat connections "
          "(Lord Godalming, Round 1)\n");

      int numLocs = -1;
      PlaceId *locs =
          GvGetReachableByType(gv, PLAYER_LORD_GODALMING, 1, IONIAN_SEA, false,
                               false, true, &numLocs);
...

    {
      ...
      int numLocs = -1;
      PlaceId *locs = GvGetReachableByType(gv, PLAYER_LORD_GODALMING, 2, PARIS,
...

    {
      ...
      int numLocs = -1;
      PlaceId *locs = GvGetReachableByType(gv, PLAYER_LORD_GODALMING, 1, ATHENS,
                                           false, true, false, &numLocs);
